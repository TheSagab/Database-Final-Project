...
<html lang="en">
  <head>
    <title>Regular Polling Form</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
...
cursor: pointer;
 ...
 $query = "INSERT INTO BMNC.POLLING_BIASA(id_polling, deskripsi)VALUES(MAX(id_polling)+1".$_POST["deskripsi"].");";
 $query2 = "INSERT INTO BMNC.POLLING(id, polling_start, polling_end)VALUES( MAX(id)+1, " .$_POST["waktu mulai"].", ".$_POST["waktu selesai"].");";
 $pbiasa = pg_query($connection, $query);
 $pbiasa2 = pg_query($connection, $query2);
 pg_close($connection);
...
<p>
<label>Pertanyaan Seputar Polling

...
cursor: pointer;
 ...
 $query = "INSERT INTO BMNC.POLLING_BERITA(id_polling ,url_berita)VALUES(MAX(id_polling)+1, ".$_POST["url berita"].");";
 $query2 = "INSERT INTO BMNC.POLLING(id, polling_start, polling_end)VALUES(MAX(id)+1, ".$_POST["waktu mulai"].", ".$_POST["waktu selesai"].");";
 $pberita = pg_query($connection, $query);
 $pberita2 = pg_query($connection, $query2);
 pg_close($connection);
...
<header>
	...
	<div class="container">
	<h2>News Polling Form</h2>
<form action="index.php" class="myForm" method="post" enctype="application/x-www-form-urlencoded">

<p>
<label>Url Berita
<input type="url berita" name="url berita">
</label> 
</p>

<p>
<label>Waktu Mulai 
<input type="time" name="waktu mulai">
</label>
</p>

<p>
<label>Waktu Selesai
<input type="time" name="waktu selesai">
</label>
</p>

<p>
<label>Jumlah Kata
<input type="text" name="pertanyaan seputar polling">
</label>
</p>
